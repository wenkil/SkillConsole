        ...
        <div className="grid gap-5 px-6 py-5">
          ...
          {mode === "target_vs_no_skill" ? (
            <div className="grid gap-1.5 text-sm font-semibold">
              {t("start.skillDraft")}
              <div className="min-h-10 border border-border-default bg-background px-3 py-2.5 font-mono text-sm">
                {draft
          ...
          {validSelection && selectedRevision ? (
            <div className="grid grid-cols-3 gap-px overflow-hidden rounded-2xl border border-border bg-rule">
              ...
              <div className="bg-background p-3">
                ...
                {mode === "target_vs_no_skill" ? (
                  <span className="ui-meta mt-1 block truncate">
          ...
          <div className="grid grid-cols-[auto_minmax(0,1fr)] gap-3 border border-technical/45 bg-technical/6 p-4">
            ...
            <div>
              ...
              {selectedRevision ? (
                <>
                  <div className="ui-meta mt-3 border border-border-default bg-border-default">
          ...
          <label className="flex items-start gap-3 border border-border-subtle bg-paper-muted px-4 py-3 text-sm leading-6">
            <input
              checked={confirmed}
              className="mt-1"
